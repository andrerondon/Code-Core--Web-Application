...
module.exports = {
  ...
  development: {
    ...
    connection: {
      database: 'blog_on_express_10' // this is the name of the datbase our app will connect to. You need to create this database with the command `createdb <databse_name>` if you have not already
